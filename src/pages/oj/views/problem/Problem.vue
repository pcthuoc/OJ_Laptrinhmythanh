  ...
  <div class="flex-container">
    <div id="problem-main">
      ...
      <Panel :padding="40" shadow>
        <div class="report"><a title="Báo lỗi bài tập này" target="_blank" onclick="event.preventDefault();window.open('https://github.com/pcthuoc/comment/issues/1', '_blank');" rel="noreferrer nofollow noopener"><i class="ivu-icon ivu-icon-md-bug"></i> {{$t('m.Report')}}</a></div>
      ...
      <Card :padding="20" dis-hover>
        ...
        <ul style="margin-left: 30px;margin-top: 20px;">
          <li><a rel="nofollow noopener noreferrer" target="_blank" class="animation-text" href="https://gist.github.com/pcthuoc/18de8a0b22fcd6101a99403a5c5a3e59">Quy tắc thảo luận &#38; hướng dẫn đăng bình luận ✍️</a></li>
          ...
          <li title="BOT của laptrinhmythanh cũng sẽ thường xuyên kiểm duyệt nha"><span style="font-weight: 600;">KHÔNG NÊN</span> để lộ thông tin cá nhân (SĐT, email, Facebook, ...)</li>
        </ul>
        <script type="application/javascript" src="https://utteranc.es/client.js" repo="pcthuoc/comment" issue-term="url" theme="github-light" crossorigin="anonymous" async> </script>
      </Card>
    </div>
    <div id="right-column">
      ...
      <Card id="pieChart" :padding="0" v-if="!this.contestID || OIContestRealTimePermission">
        <div slot="title">
          ...
          <Button size="small" id="detail" @click="graphVisible = !graphVisible">{{$t('Chi tiết')}}</Button>
        </div>
        <div class="echarts">
